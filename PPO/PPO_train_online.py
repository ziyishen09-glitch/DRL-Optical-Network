...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--topology", default="COST239_Failure", help="Topology identifier for the network")
    parser.add_argument("--channels", type=int, default=8, help="Number of wavelengths per link")
    parser.add_argument("--episodes", type=int, default=600, help="Total episodes to run; overrides num_sim * loads")
    parser.add_argument("--episode-length", type=int, default=2000, help="Requests per episode before reset")
    parser.add_argument(
        "--episode-load",
        type=float,
        default=150,
    ...
    parser.add_argument("--max-time-slots", type=int, default=3, help="Max time-slot choices per request (t)")
    parser.add_argument("--load-levels-min", type=float, default=50, help="Min load for one-hot encoding levels")
    parser.add_argument("--load-levels-max", type=float, default=150, help="Max load for one-hot encoding levels")
    parser.add_argument("--load-levels-step", type=float, default=10, help="Step between one-hot encoding levels")
