...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--episodes", type=int, default=2000, help="Total episodes to run; overrides num_sim * loads")
    parser.add_argument("--episode-length", type=int, default=600, help="Requests per episode before reset")
    parser.add_argument(
        "--episode-length-max",
        type=int,
        default=None,
    ...
    parser.add_argument("--max-time-slots", type=int, default=1, help="Max time-slot choices per request (t)")
