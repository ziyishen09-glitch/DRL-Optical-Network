...
from rwa_wdm.util import coerce_link_argument, validate_args
...
def main(config: dict | None = None) -> int:
    try:
        ...
        failure_link = coerce_link_argument(cfg.get('failure_link'))
        args = Namespace(
            ...
            failure_lookup_path=cfg.get('failure_lookup_path'),
            failure_lookup_k=cfg.get('failure_lookup_k', cfg.get('y', 2)),
            precompute_failure_lookup=cfg.get('precompute_failure_lookup', True),
            runner=cfg['runner'],
