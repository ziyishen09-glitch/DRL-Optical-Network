...
class COST239_Failure(Network):
    ...
    def get_edges(self) -> List[Tuple[int, int, int]]:
        ...
        # Simulate one random link failure by removing a random edge.
        # fail_index = rnd_fail.randrange(len(edges))
        fail_index = 5
        del edges[fail_index]
        return edges
